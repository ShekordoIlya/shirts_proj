    ...
    <section id="contacts" className={styles.section}>
      <div className={styles.inner}>
        <div>
          ...
          <p>
            Напишите, сколько маек вам нужно, какого цвета и прикрепите логотип —
            мы вернёмся с расчётом и предложениями по материалам.
          </p>
        </div>
        <div className={styles.list}>
          ...
          <a
            href="https://instagram.com/eshirts"
            className={styles.item}
            target="_blank"
            rel="noreferrer"
          >
